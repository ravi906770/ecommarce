...
const HomePage = () => {
  ...
  return (
    <Layout title={"Ecommarce App - Shop Now"}>
       <img
         ...
         {products?.map((p) => (
                <div className="card m-2" style={{ width: "18rem" }}>
                  ...
                  <div className="card-body">
                    ...
                    <h6 className="card-text card-price">${p.price}</h6>
                    <Button className='btn btn-primary p-1 m-1' onClick={()=>navigate(`/product/${p.slug}`)} >More Details</Button>
                    <Button className='btn btn-success p-1 m-1' onClick={() => {
                        setCart([...cart, p]);
